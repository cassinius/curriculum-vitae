...
\aboutme{
	...
	He is currently applying his skills to creating iNodis, a next generation online recommendation service running on personalized, context-aware graphs directly on the client.
...
\skills{
	{negotiation \& communication/3.3},
	{software modeling/4},
	{graph implementation \& testing/4.5},
	{web development/4.7},
	{presentation/4.9},
	{organizational \& constructive attitude/5.2},
	{JS algorithmic development/5.4},
	{evolutionary thinking/5.95}}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitemshort{2018-->}{Founder of iNodis, a graph-based recommender service}
